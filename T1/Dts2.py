...
#
# oDataSet = DataSet()
# base = np.loadtxt("dataset2.txt", usecols=range(2), delimiter=",")
# classes = np.loadtxt("dataset2.txt", dtype=object, usecols=-1, delimiter=",")
#
...
# oExp.save("Objects/EXP01_PS_20.gzip".format())

oExp = Experiment.load("Objects/EXP01_PS_20.gzip".format())
