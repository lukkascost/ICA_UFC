...
oDataSet = DataSet()
base = np.loadtxt("Datasets/AND.txt", usecols=range(2), delimiter=",")
classes = np.loadtxt("Datasets/AND.txt", dtype=float, usecols=-1, delimiter=",")
